<div align="center">
  <img src="./images/hermes-router.png?1" alt="Hermes Router Dashboard" width="800"/>
  
  # Hermes Router - FREE AI Router & Token Saver
  
  **Never stop coding. Save 20-40% tokens with RTK + auto-fallback to FREE & cheap AI models.**
  
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  
  [![npm](https://img.shields.io/npm/v/hermes-router.svg)](https://www.npmjs.com/package/hermes-router)
  [![Downloads](https://img.shields.io/npm/dm/hermes-router.svg)](https://www.npmjs.com/package/hermes-router)
  [![Docker Pulls](https://img.shields.io/docker/pulls/quangdigiaz/hermes-router.svg?logo=docker&label=Docker%20pulls)](https://hub.docker.com/r/quangdigiaz/hermes-router)
  [![GHCR](https://img.shields.io/badge/GHCR-quangdigiaz%2Fhermes-router-blue?logo=github)](https://github.com/quangdigiaz/hermes-router/pkgs/container/hermes-router)
  [![License](https://img.shields.io/npm/l/hermes-router.svg)](https://github.com/quangdigiaz/hermes-router/blob/main/LICENSE)

<a href="https://trendshift.io/repositories/22628" target="_blank"><img src="https://trendshift.io/api/badge/repositories/22628" alt="quangdigiaz%2Fhermes-router | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
...
## 📊 Comparison: Hermes Router vs OmniRoute

### Logic & Backend — what each has

| Feature | Hermes Router | OmniRoute |
|---------|---------|-----------|
| **Circuit breaker** | ✅ JS, in-memory (no DB dependency) | ✅ TypeScript + DB persistence |
| **Account semaphore** | ✅ JS, ported + proxy-aware | ✅ TypeScript |
| **Provider-level failure tracking** | ✅ ported, with dedup bound 10K | ✅ with 5s dedup |
| **Provider exhaustion detection** | ✅ ported + tightened regex | ✅ `isProviderExhaustedReason()` |
| **429 excluded from breaker** | ✅ Only 5xx/timeout counts | ❌ (429 counts) |
...
| **Model lockout** | ✅ DB flat field | ✅ in-memory Map |
| **RTK + Caveman + Ponytail** | ✅ | ✅ |
| **NVIDIA Kimi stream coercion** | ✅ | ✅ |
| **Per-API-key ACL** | ✅ inherited | ❌ |
| **Format translation** | ✅ OpenAI↔Claude↔Gemini↔Kiro | ✅ |
| **Kimi native tool parser** | ✅ inherited + hardened | ✅ |
| **Combo strategies** | 4 (fallback/RR/fusion/capacity) | 17 |
| **Settings cache (TPS)** | ✅ 5s TTL cache | ❌ (3 sync DB reads/req) |
| **Connections cache (TPS)** | ✅ 2s TTL cache + invalidation | ❌ (1 sync DB read/req) |
| **Per-provider mutex** | ✅ per-provider parallel selection | ❌ (global mutex) |
| **Provider count** | 40+ + AgentRouter | 231+ |

### What Hermes Router has that OmniRoute doesn't

1. **Kimchi CLI alignment** — Hermes Router's Kimchi provider masquerades as the official Kimchi CLI, with exactly the same 5 models, capabilities, and temperature rules
...
### What Hermes Router does NOT have (yet)

- OmniRoute's 17 combo strategies (Hermes Router has 4)
- OmniRoute's `sessionPool` with fingerprint rotation
- OmniRoute's `autoCombo` with complexity routing and task fitness scoring
- OmniRoute's 231 providers (Hermes Router has 40+)
...
This repository package is private (`hermes-router-app`), so source/Docker execution is the expected local development path.
...
<table>
  ...
  <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
    <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với Hermes Router" width="300"/>
  </a><br/>
  <b>🇻🇳 Tiếng Việt</b><br/>
  <sub>Tiết kiệm chi phí LLM cho OpenClaw với Hermes Router<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
</td>
<td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="Hermes Router + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>Hermes Router + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="Hermes Router Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>Hermes Router + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="Hermes Router Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>Hermes Router + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    ...
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with Hermes Router 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + Hermes Router<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup Hermes Router 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy Hermes Router di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy Hermes Router di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
...
> 🎬 **Made a video about Hermes Router?** Submit a [Pull Request](https://github.com/quangdigiaz/hermes-router/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

Hermes Router works seamlessly with all major AI coding tools:
...
Set `X-Hermes Router-Token-Saver: off` to bypass all token savers for one chat request.
...
Headroom is optional and runs separately. Hermes Router calls Headroom's local `/v1/compress` endpoint, then keeps normal routing, fallback, auth, and usage tracking:

```
Client → Hermes Router → Headroom /v1/compress → Hermes Router → provider
```
...
If Headroom is down or returns an error, Hermes Router fails open and sends the original request.
...
- Your CLI tool sends OpenAI format → Hermes Router translates → Provider receives native format
...
> Hermes Router itself **never charges** you anything. You only pay providers directly (if using paid services).
>
...
### 📊 Understanding Hermes Router Costs & Billing

**Hermes Router Billing Reality:**

✅ **Hermes Router software = FREE forever** (open source, never charges)  
✅ **Dashboard "costs" = Display/tracking only** (not actual bills)  
✅ **You pay providers directly** (subscriptions or API fees)  
✅ **FREE providers stay FREE** (iFlow, Kiro, Qwen = $0 unlimited)  
❌ **Hermes Router never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, Hermes Router just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **Hermes Router**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through Hermes Router.
...
<details>
<summary><b>💳 Will I be charged by Hermes Router?</b></summary>

**No.** Hermes Router is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**

- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, Hermes Router just routes your requests
- ❌ **Hermes Router itself** → **Never charges anything, ever**

Hermes Router is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
Hermes Router just routes your requests to them - there's no "catch" or future billing. They're truly free services, and Hermes Router makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - Hermes Router helps maximize their value through quota tracking
...
Hermes Router's smart fallback prevents surprise charges:

**Scenario:** You're on a coding sprint and blow through your quotas

**Without Hermes Router:**
...
**You're in control:** Set spending limits per provider in dashboard, and Hermes Router respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. Hermes Router tracks quota per model!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from Hermes Router dashboard]
...
```json
{
  ...
  "anthropic_api_key": "your-hermes-router-api-key"
}
```
...
export OPENAI_API_KEY="your-hermes-router-api-key"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "hermes-router/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Note:** OpenClaw only works with local Hermes Router. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
```bash
# Clone and install
git clone https://github.com/quangdigiaz/hermes-router.git
cd Hermes Router
npm install
npm run build
...
export DATA_DIR="/var/lib/hermes-router"
export PORT="20128"
...
# Or use PM2
npm install -g pm2
pm2 start npm --name hermes-router -- start
pm2 save
pm2 startup
```
...
- GHCR: [`ghcr.io/quangdigiaz/hermes-router`](https://github.com/quangdigiaz/hermes-router/pkgs/container/hermes-router)
...
docker run -d --name hermes-router -p 20128:20128 \
  -v "$HOME/.hermes-router:/app/data" -e DATA_DIR=/app/data hermes-router
```
...
```bash
docker logs -f hermes-router
docker restart hermes-router
docker stop hermes-router && docker rm hermes-router
docker pull ghcr.io/quangdigiaz/hermes-router:latest   # update to latest
```

**Data persistence:** `$HOME/.hermes-router/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable                                             | Default                                  | Description                                                                         |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET`                                         | Auto-generated (`~/.hermes-router/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances)   |
| `INITIAL_PASSWORD`                                   | `123456`                                 | First login password when no saved hash exists                                      |
| `DATA_DIR`                                           | `~/.hermes-router`                             | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`)                       |
| `PORT`                                               | framework default                        | Service port (`20128` in examples)                                                  |
| `HOSTNAME`                                           | framework default                        | Bind host (Docker defaults to `0.0.0.0`)                                            |
| `NODE_ENV`                                           | runtime default                          | Set `production` for deploy                                                         |
| `BASE_URL`                                           | `http://localhost:20128`                 | Server-side internal base URL used by cloud sync jobs                               |
| `CLOUD_URL`                                          | empty                               | Server-side cloud sync endpoint base URL                                            |
| `NEXT_PUBLIC_BASE_URL`                               | `http://localhost:3000`                  | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime)          |
| `NEXT_PUBLIC_CLOUD_URL`                              | empty                               | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime)        |
...
- Both `${DATA_DIR}` and `~/.hermes-router` resolve to the same location in a Docker container — the symlink `/root/.hermes-router -> /app/data` is created at build time.
...
- Auto-refreshed by Hermes Router
...
- **GitHub**: [github.com/quangdigiaz/hermes-router](https://github.com/quangdigiaz/hermes-router)
- **Issues**: [github.com/quangdigiaz/hermes-router/issues](https://github.com/quangdigiaz/hermes-router/issues)

---

## 👥 Contributors

Thanks to all contributors who helped make Hermes Router better!

[![Contributors](https://contrib.rocks/image?repo=quangdigiaz/hermes-router&max=150&columns=15&anon=1&v=20260309)](https://github.com/quangdigiaz/hermes-router/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/quangdigiaz/hermes-router.svg?variant=adaptive)](https://github.com/quangdigiaz/hermes-router)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of Hermes Router. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. Hermes Router ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. Hermes Router adapts its prompt → **−65% output tokens**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) by **[@DietrichGebert](https://github.com/DietrichGebert)** — _"lazy senior dev"_ skill. Hermes Router injects its YAGNI-first ladder → **fewer tokens, less code, shorter diffs**.

Huge thanks to these authors — without their work, Hermes Router's token-saving features wouldn't exist. ⭐ them on GitHub!
