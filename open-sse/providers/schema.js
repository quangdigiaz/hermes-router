 ...
 * @property {string}  [curatedTier]     Curation tier: "official"|"bridge"|"free"|"community"|"experimental"
 * @property {string[]} [badges]         UI badge tags: ["recommended","new","deprecated","popular",...]
 * @property {number}  [curatedPriority] Override sort order within curation tiers (higher = shown first)
 *
