export default {
  ...
  display: {
    ...
    notice: {
      ...
      text: "OrcaRouter AI Gateway. Các model Free Tier (orcarouter/free, deepseek-v4-flash-free) được miễn phí $0, tự động reset quota vào 00:00 UTC. Nạp $1 mở khóa hạn mức lớn hơn và bỏ giới hạn prompt token.",
    },
  },
  category: "apikey",
  authType: "apikey",
