...
export const MODEL_PRICING = {
  ...
  "mimo-v2":                      { input: 0.14,  output: 0.28,  cached: 0.0028, reasoning: 0.28,   cache_creation: 0.14  },

  // === Qwen Extra ===
  "qwen3.8-max":                  { input: 1.60,  output: 6.40,  cached: 0.40,  reasoning: 6.40,   cache_creation: 1.60  },
  "qwen-3.8-max":                 { input: 1.60,  output: 6.40,  cached: 0.40,  reasoning: 6.40,   cache_creation: 1.60  },
...
export function formatCost(cost) {
  ...
  if (cost > 0 && cost < 0.005) return `$${cost.toFixed(4)}`;
