 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what Hermes Router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a hermes-router
...
/**
 * Detect whether a model id refers to a Hermes Router synthetic agentic variant.
...
/**
 * Detect whether a model id is a Hermes Router synthetic thinking variant
...
/**
 * Resolve a Hermes Router model id to the real upstream Kiro model id, plus flags
