...
function MenuItem({ icon, label, onClick, trailing, danger }) {
  return (
    ...
    >
      <span className={`material-symbols-outlined text-[20px] ${danger ? "" : "text-text-main"}`}>
        {icon}
      </span>
    ...
    <>
      <div className="relative" ref={menuRef}>
        <button type="button"
          ...
          className="flex items-center justify-center p-2 rounded-lg text-text-main hover:text-text-main hover:bg-surface-2 transition-all"
          title="Menu"
        >
