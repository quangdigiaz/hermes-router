...
const PROVIDER_NAME = "hermes-router";
...
// Build TOML config for Hermes Router (openai provider mode)
const buildHermesRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect Hermes Router by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildHermesRouterConfig(baseUrl, apiKey || "sk_hermes-router", model);
