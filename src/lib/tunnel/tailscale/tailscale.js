...
// Check if a system-level tailscaled is running (uses system socket, not Hermes Router's custom one).
 ...
 * State always lives in ~/.hermes-router/tailscale/ via --statedir.
 */
