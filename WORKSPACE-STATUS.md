...
|---|---|---|
| **Remove Groq & Fireworks AI Providers** | ✅ **Completed & Verified — baselines regenerated byte-for-byte, related tests pass** | Research: `_tasks/research/2026-08-22_remove-groq-fireworks-providers.md`<br>Plan: `playbooks/plan-remove-groq-fireworks-providers.md` (kèm fix import `heroku.js` đứt có sẵn trong registry) |
