...
Common questions about Hermes Router.

---

## What is Hermes Router?

**Hermes Router is an AI model router that maximizes your subscription value and minimizes costs.**
...
**Hermes Router uses a 3-tier pricing strategy:**
...
## Is Hermes Router free?

**Yes, Hermes Router itself is 100% free and open source.**
...
**Yes! This is Hermes Router's core feature.**
...
**Hermes Router tracks quota in real-time for all providers:**
...
## Can I self-host Hermes Router?

**Yes! Hermes Router supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.hermes-router`)
...
**Yes, Hermes Router prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.hermes-router` (or custom `DATA_DIR`)
- No data sent to Hermes Router servers
...
**What Hermes Router stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What Hermes Router does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/quangdigiaz/hermes-router/blob/main/CHANGELOG.md)
- Backup `~/.hermes-router` before major updates
...
See [CONTRIBUTING.md](https://github.com/quangdigiaz/hermes-router/blob/main/CONTRIBUTING.md) for details.
