...
Integrate Hermes Router with Cursor IDE to route your AI requests through Hermes Router's intelligent routing system.

## Prerequisites

- Cursor IDE installed
- Cursor Pro account (required for custom API endpoints)
- Hermes Router cloud endpoint configured
- API key from Hermes Router dashboard

## ⚠️ Important Notes

> **Cloud Endpoint Required**: Cursor routes requests through its own server and does not support localhost endpoints. You must use the Hermes Router cloud endpoint: `https://your-cloud-endpoint.com`
...
Set the base URL to Hermes Router cloud endpoint:
...
2. Enter: `https://your-cloud-endpoint.com`
3. Click **Save**
...
3. Enter the model name from your Hermes Router configuration (e.g., `gpt-4`, `claude-opus-4-5`, etc.)
4. Click **Add**
...
3. Start using Hermes Router with Cursor!
...
3. Start chatting with AI through Hermes Router
...
2. Press Cmd/Ctrl + K
3. Enter your prompt
4. Cursor will use Hermes Router to generate code
...
4. Get AI-powered explanations through Hermes Router
...
1. Verify you are using the cloud endpoint: `https://your-cloud-endpoint.com`
2. Check your internet connection
3. Ensure Hermes Router cloud service is operational
4. Try disabling VPN or proxy if enabled

### Localhost Not Working

> **Remember**: Cursor does not support localhost endpoints. You must use the cloud endpoint `https://your-cloud-endpoint.com`. If you need to use a local Hermes Router instance, consider using a tunneling service like ngrok to expose your local endpoint.

## Cloud Endpoint Setup

If you're running Hermes Router locally and want to use it with Cursor:

1. Enable cloud endpoint in Hermes Router settings
2. Configure your cloud endpoint URL in Hermes Router dashboard
3. Use the cloud URL in Cursor settings
4. Ensure your local Hermes Router instance is accessible from the internet

## Best Practices

1. **Use Model Aliases**: Create short aliases for frequently used models in Hermes Router
