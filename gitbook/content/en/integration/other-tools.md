...
Hermes Router is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

Hermes Router provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to Hermes Router using these settings:
...
**Cloud Hermes Router:**
```
Base URL: your-cloud-endpoint.com/v1
API Key: your-api-key-from-dashboard
Model: any Hermes Router model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to Hermes Router
```bash
...
**Solution:**
- Verify Hermes Router is running
...
- Check network connection to Hermes Router
