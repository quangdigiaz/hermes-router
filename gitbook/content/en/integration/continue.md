...
Integrate Hermes Router with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Hermes Router API key from [dashboard](https://your-instance.com/dashboard)
- Hermes Router running (local or cloud)
...
### 2. Add Hermes Router Model Configuration
...
3. Choose your preferred Hermes Router model
...
- Check network latency to Hermes Router
