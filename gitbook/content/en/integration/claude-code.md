...
Integrate Hermes Router with Claude Code CLI to route your Anthropic API requests through Hermes Router's intelligent routing system.
...
Claude Code supports the following model aliases that map to Hermes Router models:
