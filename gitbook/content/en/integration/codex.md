...
Integrate Hermes Router with OpenAI Codex CLI to route your OpenAI API requests through Hermes Router's intelligent routing system.
...
Hermes Router provides the following Codex models:
...
1. Verify your API key is correct in Hermes Router dashboard
...
1. Verify the model name matches your Hermes Router configuration
2. Check that the OpenAI provider connection is active in Hermes Router dashboard
...
Make sure you have configured your API key in the Hermes Router cloud dashboard.
