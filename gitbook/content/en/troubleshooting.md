...
Common issues and solutions when using Hermes Router.
...
1. **Auto-refresh (default):**
   Hermes Router automatically refreshes tokens. Wait 30 seconds and retry.
...
**Causes:**
- Hermes Router not running
- Port 20128 blocked
- Firewall blocking connection

**Solutions:**

1. **Start Hermes Router:**
   ```bash
   hermes-router
   ```
...
4. **Use cloud endpoint:**
   ...
   ```
   Endpoint: your-cloud-endpoint.com/v1
   ```
...
- Hermes Router crashed
- Browser cache issues

**Solutions:**

1. **Check if Hermes Router is running:**
   ```bash
   # Check process
