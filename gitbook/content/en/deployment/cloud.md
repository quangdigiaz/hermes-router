...
Deploy Hermes Router on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.hermes-router` | Database and data storage path |
...
Create `/etc/nginx/sites-available/hermes-router`:
