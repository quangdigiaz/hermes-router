...
Detailed installation guide for Hermes Router with troubleshooting tips.
...
Install Hermes Router globally to use from anywhere:
...
- ✅ Simple command: `hermes-router`
- ✅ Auto-updates with `npm update -g hermes-router`
...
3. Data directory created at `~/.hermes-router`
...
**Default location:** `~/.hermes-router`
...
**Issue:** Hermes Router using too much RAM
