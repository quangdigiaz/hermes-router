...
Những câu hỏi phổ biến về Hermes Router.

---

## Hermes Router là gì?

**Hermes Router là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**Hermes Router dùng chiến lược pricing 3 tầng:**
...
## Hermes Router có miễn phí không?

**Có, Hermes Router hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của Hermes Router.**
...
**Hermes Router theo dõi quota thời gian thực cho tất cả provider:**
...
## Hermes Router có hoạt động với Cursor không?

**Có, nhưng Cursor yêu cầu endpoint cloud.**

**Vấn đề:** Cursor IDE không hỗ trợ endpoint localhost.

**Giải pháp:** Dùng Hermes Router cloud deployment:
...
## Tôi có thể self-host Hermes Router không?

**Có! Hermes Router hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.hermes-router`)
...
**Có, Hermes Router ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.hermes-router` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server Hermes Router
...
## Làm thế nào để cập nhật Hermes Router?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/quangdigiaz/hermes-router/blob/main/CHANGELOG.md)
- Backup `~/.hermes-router` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/quangdigiaz/hermes-router/blob/main/CONTRIBUTING.md) để biết chi tiết.
