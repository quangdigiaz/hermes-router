...
Hướng dẫn cài đặt chi tiết cho Hermes Router với mẹo troubleshooting.
...
Cài Hermes Router toàn cục để dùng ở bất kỳ đâu:

```bash
npm install -g hermes-router
```

**Khởi động Hermes Router:**
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `hermes-router`
- ✅ Auto-update với `npm update -g hermes-router`
...
3. Data directory được tạo tại `~/.hermes-router`
...
**Vấn đề:** Hermes Router dùng quá nhiều RAM
...
# Delete hermes-router-related exports
```
