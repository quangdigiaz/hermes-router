...
Hermes Router tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

Hermes Router cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến Hermes Router bằng các cài đặt sau:

**Hermes Router cục bộ:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any Hermes Router model (cc/*, cx/*, glm/*, etc.)
```
...
**Vấn đề:** Không kết nối được đến Hermes Router
```bash
...
**Giải pháp:**
- Xác minh Hermes Router đang chạy
...
- Kiểm tra kết nối network đến Hermes Router
