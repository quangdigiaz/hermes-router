...
Tích hợp Hermes Router với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model Hermes Router có sẵn:
...
### Connection Failed
- Xác minh Hermes Router đang chạy: `curl http://localhost:20128/health`
