...
Tích hợp Hermes Router với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- Hermes Router API key từ [dashboard](https://your-instance.com/dashboard)
- Hermes Router đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model Hermes Router
...
3. Chọn model Hermes Router ưa thích
...
- Kiểm tra Hermes Router đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến Hermes Router
