...
Các vấn đề và giải pháp phổ biến khi dùng Hermes Router.
...
1. **Auto-refresh (mặc định):**
   Hermes Router tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- Hermes Router không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động Hermes Router:**
   ```bash
   hermes-router
   ```
...
- Hermes Router bị crash
- Vấn đề cache browser

**Giải pháp:**

1. **Kiểm tra Hermes Router có chạy không:**
   ```bash
   # Check process
