...
トラブルシューティングのヒント付きのHermes Router詳細インストールガイド。
...
どこからでも使用できるようにHermes Routerをグローバルインストール:
...
**利点:**
- ✅ どのディレクトリからでも実行
- ✅ シンプルなコマンド: `hermes-router`
- ✅ `npm update -g hermes-router` で自動更新
...
3. `~/.hermes-router` にデータディレクトリが作成される
4. APIキーが自動生成される
