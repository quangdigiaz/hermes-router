...
Hermes RouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをHermes Routerのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはHermes Routerモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がHermes Routerの設定と一致しているか確認
