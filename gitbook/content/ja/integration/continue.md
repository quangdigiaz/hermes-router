...
Hermes RouterをContinue拡張機能と統合し、Visual Studio Codeに直接AIアシスタンスを導入します。

## 前提条件

- Visual Studio Codeがインストール済み
- VSCodeマーケットプレイスからContinue拡張機能がインストール済み
- [ダッシュボード](https://your-instance.com/dashboard)からのHermes Router APIキー
- Hermes Routerが動作中 (ローカルまたはクラウド)
