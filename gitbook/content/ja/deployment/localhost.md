...
開発と個人利用のため、ローカルマシンでHermes Routerを実行。

---

## 📦 インストール

npm経由でHermes Routerをグローバルインストール:
...
Hermes Routerが実行されているターミナルで `Ctrl+C` を押します。

```bash
# hermes-routerを実行しているターミナル
^C  # Ctrl+Cを押す
```
