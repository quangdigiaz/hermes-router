...
Integra Hermes Router con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de Hermes Router.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de Hermes Router:
...
```bash
export ANTHROPIC_BASE_URL="https://your-cloud-endpoint.com"
```
