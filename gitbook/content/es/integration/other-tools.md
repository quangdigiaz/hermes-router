...
Hermes Router es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

Hermes Router proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a Hermes Router usando estas configuraciones:

**Hermes Router local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Hermes Router (cc/*, cx/*, glm/*, etc.)
```

**Hermes Router en la nube:**
```
Base URL: https://your-cloud-endpoint.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Hermes Router (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a Hermes Router
```bash
# Verifica si Hermes Router está corriendo
...
**Solución:**
- Verifica que Hermes Router esté corriendo
...
- Verifica la conexión de red a Hermes Router
