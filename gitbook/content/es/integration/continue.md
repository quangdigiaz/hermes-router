...
Integra Hermes Router con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de Hermes Router desde el [dashboard](https://your-instance.com/dashboard)
- Hermes Router ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de Hermes Router
...
```json
{
  "models": [
    {
      "title": "Hermes Router - Claude Opus",
      "provider": "openai",
...
```json
{
  "models": [
    {
      "title": "Hermes Router - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "Hermes Router - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "Hermes Router - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "Hermes Router - Claude Haiku (Fast)",
      "provider": "openai",
...
```json
"apiBase": "https://your-cloud-endpoint.com/v1"
```
...
3. Elige tu modelo preferido de Hermes Router
...
```json
{
  "models": [
    {
      "title": "Hermes Router - Code Expert",
      "provider": "openai",
      "model": "cx/deepseek-chat",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
```json
{
  "models": [
    {
      "title": "Hermes Router - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que Hermes Router esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de Hermes Router
...
- Verifica la latencia de red hacia Hermes Router
