...
Integra Hermes Router con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de Hermes Router.
...
Hermes Router proporciona los siguientes modelos de Codex:
...
```json
{
  ...
  "apiKey": "your-hermes-router-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de Hermes Router
...
1. Verifica que el nombre del modelo coincida con tu configuración de Hermes Router
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de Hermes Router
...
```bash
export OPENAI_BASE_URL="https://your-cloud-endpoint.com"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de Hermes Router.
