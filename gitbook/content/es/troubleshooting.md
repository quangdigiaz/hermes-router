...
Problemas comunes y soluciones al usar Hermes Router.
...
1. **Refresh automático (por defecto):**
   Hermes Router refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Causas:**
- Hermes Router no está ejecutándose
- Puerto 20128 bloqueado
- Firewall bloqueando la conexión

**Soluciones:**

1. **Inicia Hermes Router:**
   ```bash
   hermes-router
   ```
...
4. **Usa el endpoint en la nube:**
   ...
   ```
   Endpoint: https://your-cloud-endpoint.com/v1
   ```
...
- Hermes Router crasheó
- Problemas de caché del navegador

**Soluciones:**

1. **Verifica si Hermes Router está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep hermes-router
...
- **GitHub Issues:** [github.com/quangdigiaz/hermes-router/issues](https://github.com/quangdigiaz/hermes-router/issues)
- **Documentación:** [your-instance.com/docs](https://your-instance.com/docs)
- **FAQ:** [faq.md](faq.md)
