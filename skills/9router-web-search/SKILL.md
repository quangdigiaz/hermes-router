---
name: hermes-router-web-search
description: Web search via Hermes Router /v1/search using Tavily / Exa / Brave / Serper / SearXNG / Google PSE / Linkup / SearchAPI / You.com / Perplexity. Use when the user wants to search the web, look up information, find articles, or query a search engine.
---

# Hermes Router — Web Search
...
curl -X POST $NINEROUTER_URL/v1/search \
  ...
  -d '{"model":"tavily","query":"Hermes Router open source","max_results":5}'
```
...
{
  "provider": "tavily",
  "query": "Hermes Router open source",
  "results": [
    {
