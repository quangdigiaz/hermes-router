...
if (require.main === module) {
  ...
  console.log("📦 Building Hermes Router CLI package with Next.js...\n");
  ...
  // e.g. .next-cli-build/standalone/hermes-router/server.js
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.hermes-router/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.hermes-router/runtime)");
  }
  console.log("");
