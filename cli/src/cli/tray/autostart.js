...
const APP_LABEL = "com.hermes-router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when Hermes Router is currently
 ...
 * SIGTERM to the running process. When the running Hermes Router cli.js was itself
...
<dict>
    ...
    <string>/tmp/hermes-router.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/hermes-router-error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `hermes-router.cmd` lookup that depended on the npm prefix path.
...
Type=Application
Name=Hermes Router
Comment=Hermes Router API Proxy
