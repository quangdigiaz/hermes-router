# Custom Logic — Hermes Router (Hermes Router Fork)

This document details all custom logic added on top of the upstream Hermes Router codebase.
...
## 9. Hermes Router Branding

### Files
- `src/app/layout.js` — Title: "Hermes Router - AI Infrastructure Management"
- `src/dashboardGuard.js` — API welcome: "Welcome to Hermes Router! Use {baseUrl}/v1 as your API endpoint."
...
| `src/app/layout.js` | Hermes Router branding + upstream GA/font script |
