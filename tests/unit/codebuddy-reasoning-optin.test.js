...
describe("CodeBuddyExecutor reasoning params are opt-in (#2071)", () => {
  ...
  it("sanitizes agent system prompt for CodeBuddy CN", () => {
    const out = exec.transformRequest("glm-5.2", { messages: [{ role: "system", content: "You are Claude Code, Anthropic's official CLI" }, { role: "user", content: "hi" }] }, false, {});
